...
%define po_package scarecrow-session-3.0
...
Name: scarecrow-session
Version: 3.39.0
Release: 1%{?dist}
Summary: GNOME session manager

License: GPLv2+
URL: https://github.com/scarecrow-de/scarecrow-gnome-session
Source0: https://github.com/scarecrow-de/scarecrow-gnome-session/archive/refs/heads/main.tar.gz
...
Requires: scarecrow-control-center-filesystem

Requires: scarecrow-gsettings-desktop-schemas >= 0.1.7
...
%doc %{_mandir}/man*/*
%{_bindir}/*
%{_libexecdir}/scarecrow-session-binary
%{_libexecdir}/scarecrow-session-check-accelerated
%{_libexecdir}/scarecrow-session-check-accelerated-gl-helper
%{_libexecdir}/scarecrow-session-check-accelerated-gles-helper
%{_libexecdir}/scarecrow-session-ctl
%{_libexecdir}/scarecrow-session-failed
%{_datadir}/scarecrow-session/
%{_datadir}/doc/scarecrow-session/dbus/scarecrow-session.html
...
- Update to 3.39.0. Initial scarecrow-session release
