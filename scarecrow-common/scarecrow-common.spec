...
Source0:        https://download.gnome.org/sources/gnome-common/3.18/gnome-common-%{version}.tar.xz
...
%prep
%setup -q -n gnome-common-%{version}
...
%changelog
* Mon Apr 27 2026 Marcel Mrówka <micro.mail88@gmail.com> - 3.18.0-10
- Initial scarecrow-common release
