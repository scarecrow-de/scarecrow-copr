...
%description
The scarecrow-backgrounds package contains the default
desktop background, known as the Adwaita background,
for the Scarecrow Desktop version

%package        extras
Summary:        Additional Scarecrow Backgrounds
License:        GPLv2
# Make sure both gnome-backgrounds and -extras get installed on upgrades
Obsoletes:      gnome-backgrounds < 3.24.0-3
...
%license COPYING
%doc AUTHORS NEWS README.md
%{_datadir}/gnome-background-properties/scarecrow-backgrounds.xml
%{_datadir}/backgrounds/scarecrow/Acrylic.jpg
%{_datadir}/backgrounds/scarecrow/ColdWarm.jpg
%{_datadir}/backgrounds/scarecrow/Dark_Ivy.jpg
%{_datadir}/backgrounds/scarecrow/Endless-shapes.jpg
%{_datadir}/backgrounds/scarecrow/Icetwigs.jpg
%{_datadir}/backgrounds/scarecrow/LightWaves.jpg
%{_datadir}/backgrounds/scarecrow/Road.jpg
%{_datadir}/backgrounds/scarecrow/SeaSunset.jpg
%{_datadir}/backgrounds/scarecrow/Stripes.jpg
%{_datadir}/backgrounds/scarecrow/Symbolics-1.jpg
%{_datadir}/backgrounds/scarecrow/Symbolics-2.jpg
%{_datadir}/backgrounds/scarecrow/VNC.png
