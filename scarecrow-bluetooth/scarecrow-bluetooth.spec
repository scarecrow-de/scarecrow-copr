...
License:	GPLv2+
URL:		https://github.com/scarecrow-de/scarecrow-gnome-bluetooth
Source0:	https://github.com/scarecrow-de/scarecrow-gnome-bluetooth/archive/refs/heads/main.tar.gz
Source1:	61-scarecrow-bluetooth-rfkill.rules
...
%description
The scarecrow-bluetooth package contains graphical utilities to setup,
...
install -m0644 -D %{SOURCE1} $RPM_BUILD_ROOT/usr/lib/udev/rules.d/61-scarecrow-bluetooth-rfkill.rules

%find_lang scarecrow-bluetooth2
...
%{_datadir}/scarecrow-bluetooth/
%{_mandir}/man1/*
/usr/lib/udev/rules.d/61-scarecrow-bluetooth-rfkill.rules

%files -f scarecrow-bluetooth2.lang libs
%license COPYING.LIB
