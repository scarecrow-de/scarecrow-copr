...
designed for the GNOME 3 desktop.
...
touch $RPM_BUILD_ROOT%{_datadir}/icons/Adwaita-Scarecrow/icon-theme.cache

%transfiletriggerin -- %{_datadir}/icons/Adwaita-Scarecrow
gtk-update-icon-cache --force %{_datadir}/icons/Adwaita-Scarecrow &>/dev/null || :

%transfiletriggerpostun -- %{_datadir}/icons/Adwaita-Scarecrow
gtk-update-icon-cache --force %{_datadir}/icons/Adwaita-Scarecrow &>/dev/null || :

%files
%license COPYING*
%dir %{_datadir}/icons/Adwaita-Scarecrow/
%{_datadir}/icons/Adwaita-Scarecrow/8x8/
%{_datadir}/icons/Adwaita-Scarecrow/16x16/
%{_datadir}/icons/Adwaita-Scarecrow/22x22/
%{_datadir}/icons/Adwaita-Scarecrow/24x24/
%{_datadir}/icons/Adwaita-Scarecrow/32x32/
%{_datadir}/icons/Adwaita-Scarecrow/48x48/
%if ! 0%{bootstrap}
%{_datadir}/icons/Adwaita-Scarecrow/64x64/
%{_datadir}/icons/Adwaita-Scarecrow/96x96/
%endif
%{_datadir}/icons/Adwaita-Scarecrow/256x256/
%{_datadir}/icons/Adwaita-Scarecrow/512x512/
%{_datadir}/icons/Adwaita-Scarecrow/scalable/
%{_datadir}/icons/Adwaita-Scarecrow/scalable-up-to-32/
%{_datadir}/icons/Adwaita-Scarecrow/index.theme
%ghost %{_datadir}/icons/Adwaita-Scarecrow/icon-theme.cache

%files -n scarecrow-adwaita-cursor-theme
%license COPYING*
%dir %{_datadir}/icons/Adwaita-Scarecrow/
%{_datadir}/icons/Adwaita-Scarecrow/cursors/
