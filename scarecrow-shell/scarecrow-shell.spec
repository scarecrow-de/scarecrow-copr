...
%description
Scarecrow Shell provides core user interface functions for the Scarecrow 3 desktop,
like switching to windows and launching applications. Scarecrow Shell takes
...
mv "$tmpdir" /builddir/build/BUILD/%{name}-%{version}-build/scarecrow-gnome-shell-main/subprojects/gvc
...
mkdir -p %{buildroot}%{_datadir}/scarecrow-shell/extensions
mkdir -p %{buildroot}%{_datadir}/scarecrow-shell/search-providers
...
%license COPYING
%doc README.md
%caps(cap_sys_nice+ep) %{_bindir}/scarecrow-shell
%{_bindir}/scarecrow-extensions
%{_bindir}/scarecrow-shell-extension-prefs
...
%{_datadir}/xdg-desktop-portal/portals/scarecrow-shell.portal
%{_libdir}/scarecrow-shell/
%{_libexecdir}/scarecrow-shell-calendar-server
%{_libexecdir}/scarecrow-shell-perf-helper
%{_libexecdir}/scarecrow-shell-hotplug-sniffer
%{_libexecdir}/scarecrow-shell-portal-helper
%{_libexecdir}/scarecrow-shell-overrides-migration.sh
